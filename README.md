...
To update the database use this command from the Web project folder (replace `Ibra.ArdaPilot` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Ibra.ArdaPilot.Infrastructure/Ibra.ArdaPilot.Infrastructure.csproj -s Ibra.ArdaPilot.Web.csproj
```
